...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    start = time.time()
    plot_losses = []
    print_loss_total = 0  # print_every毎にリセットされる
    plot_loss_total = 0   # plot_every毎にリセットされる
...
if __name__ == '__main__':
    ...
    attn_decoder = AttnDecoderRNN(HIDDEN_SIZE, output_lang.n_words, device, dropout_p=DROPOUT_P).to(device)
